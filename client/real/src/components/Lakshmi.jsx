        ...
        <div>
            <div className="heading">
                ...
                <div className="section">
                    <h2>CASAGRAND LAKSHMI HIGHLIGHTS</h2>
                    <ul>
                        <li>Casagrand is proud to present “Casagrand LAKSHMI” – located in the heart of Chennai in Alwarpet. Casagrand Lakshmi features 6 Luxury Units structured in one block with all premium fittings and specifications.</li>
                    </ul>
                </div>
