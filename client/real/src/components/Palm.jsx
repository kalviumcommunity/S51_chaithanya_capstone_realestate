  ...
  return (
    <div>
      <div className="linore-container">
        {/* Villa Image */}
        <img src={family} alt="DreamHouse Linore" className="villa-image" />
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/QFTtGiiH474" title="Walkthrough 4" frameBorder="0" allowFullScreen></iframe>
        ...
        <table className="apartment-table">
          ...
          <tbody>
            <tr>
              <td>2 BHK</td>
              <td>Elite</td>
              <td>1165 Sqft to 1354 Sqft</td>
              <td>Rs 3849 / Sqft</td>
              <td>Rs. 51 Lakhs Onwards</td>
            </tr>
            <tr>
              <td>3 BHK</td>
              <td>Elite</td>
              <td>1786 Sqft - 1835 Sqft</td>
              <td>Rs 3799 / Sqft</td>
              <td>Rs. 74 Lakhs Onwards</td>
            </tr>
            </tbody>
        </table>
      </div>
      ...
      <div className="project-overview">
        ...
        <div className="overview-container">
          <img src={family} alt="home1" className="overview-image" />
